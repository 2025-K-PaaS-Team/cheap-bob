...
const CommonPkgNum = ({ pkg, setPkg }: PkgNumProps) => {
  return (
    <div>
      ...
      {/* notice */}
      <div className="text-[14px] absolute bottom-100 w-[350px] left-1/2 -translate-x-1/2 bg-custom-white rounded-sm h-[88px] px-[10px] flex flex-col flex justify-center">
