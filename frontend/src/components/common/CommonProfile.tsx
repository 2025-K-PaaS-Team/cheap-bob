...
const CommonProfile = ({
  ...
  return (
    <div className="absolute inset-0 z-[1000] flex flex-col items-center justify-center bg-black/20">
      <div className="w-[322px] max-h-[90vh] flex flex-col">
        <div className="bg-white rounded-t flex flex-col border-b border-black/80 w-[322px] px-[16px] py-[20px] gap-y-[8px]">
          ...
          <div className="bodyFont text-custom-black">
            전화번호 {phone ?? ""}
          </div>
        </div>
        {/* other row - custom white zone */}
        <div className="bg-custom-white rounded-b flex flex-col px-[16px] py-[20px] justify-start gap-y-[8px] overflow-y-auto flex-1">
          {/* nutrition_part */}
