...
class OrderHistoryItem(Document):
    """오래된 주문 히스토리 (Beanie Document). 자정 batch 가 OrderCurrentItem 을 여기로 이관."""
    ...
    status: str = Field(default="reservation", description="상태 (str — current 와 달리 Enum 미사용)")
    ...
    preferred_menus: Optional[str] = Field(None, max_length=500)
    nutrition_types: Optional[str] = Field(None, max_length=500)
    allergies: Optional[str] = Field(None, max_length=500)
    topping_types: Optional[str] = Field(None, max_length=500)
