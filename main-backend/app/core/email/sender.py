...
구글 SMTP 로 메시지 전송. 메시지 구성 (subject/body/html) + 도메인 이벤트 dispatch 는 호출자 책임. 
본 클래스는 transport 만 한다.
"""
...
# 모듈 싱글톤 — config 가 process 시작 시 고정이라 한 instance 면 충분.
