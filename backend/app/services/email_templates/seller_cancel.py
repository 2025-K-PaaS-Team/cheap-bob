def get_seller_cancel_text_template(timestamp: str, recipient: str, store: str) -> str:
        """가게 주문 취소 텍스트 템플릿"""
...
def get_seller_cancel_html_template(timestamp: str, recipient: str, store: str) -> str:
        """가게 주문 취소 HTML 템플릿"""
        return f"""
        <!DOCTYPE html>
        <html lang="ko">
