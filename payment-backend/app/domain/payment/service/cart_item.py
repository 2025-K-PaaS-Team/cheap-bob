"""cart_items CRUD — payment-backend 내부 DB.

기존 main-backend.OrderQueryService 의 cart 관련 메서드들을 본 서비스로 분리.
sweep/lock 등 동시성 의미 유지 — 모두 같은 payment-backend tx 안에서 작동.
"""
